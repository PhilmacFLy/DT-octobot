...
//
//----------------------------------------------------------------------------
// @Parameters    uwChannelNum: 
//                ChannelNumber : defines the channel number for parallel 
...
void ADC0_vStartParReqChNum(uword uwChannelNum)
{

   ADC0_CRCR1 |= uwChannelNum; // requested channel 

} //  End of function ADC0_vStartParReqChNum
